...
const skills: Skill[] = [
  ...
  { name: "JDA (Discord)", category: "plugin", proficiency: 90 },
  ...
  { name: "Discord Integration", category: "plugin", proficiency: 95 },
  { name: "Database Design", category: "database", proficiency: 85 },
  { name: "API Development", category: "web", proficiency: 90 },
